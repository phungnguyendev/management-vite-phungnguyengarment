...
export default {
  createItem: async (newItem: GarmentAccessory, accessToken: string): Promise<ResponseDataType | undefined> => {
    return await client
      .post(
        `${NAMESPACE}`,
        {
  ...
  getItemBy: async (query: GarmentAccessory, accessToken: string): Promise<ResponseDataType | undefined> => {
    return client
  ...
  updateItems: async (
    itemsToUpdate: GarmentAccessory[],
    accessToken: string
  ): Promise<ResponseDataType | undefined> => {
    return client
  ...
  deleteItemBy: async (query: GarmentAccessory, accessToken: string): Promise<ResponseDataType | undefined> => {
    return client
