...
export default {
  createItem: async (newItem: Print, accessToken: string): Promise<ResponseDataType | undefined> => {
    return await client
      .post(
        `${NAMESPACE}`,
        {
  ...
  updateItems: async (itemsToUpdate: Print[], accessToken: string): Promise<ResponseDataType | undefined> => {
    return client
