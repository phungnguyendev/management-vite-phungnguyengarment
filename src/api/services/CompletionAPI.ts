...
export default {
  createItem: async (newItem: Completion, accessToken: string): Promise<ResponseDataType | undefined> => {
    return await client
      .post(
        `${NAMESPACE}`,
        {
  ...
  getItemBy: async (query: Completion, accessToken: string): Promise<ResponseDataType | undefined> => {
    return client
  ...
  updateItems: async (itemsToUpdate: Completion[], accessToken: string): Promise<ResponseDataType | undefined> => {
    return client
  ...
  deleteItemBy: async (query: Completion, accessToken: string): Promise<ResponseDataType | undefined> => {
    return client
