...
export default {
  ...
  getItemBy: async (query: ProductColor, accessToken: string): Promise<ResponseDataType | undefined> => {
    return client
  ...
  deleteItemBy: async (query: ProductColor, accessToken: string): Promise<ResponseDataType | undefined> => {
    return client
